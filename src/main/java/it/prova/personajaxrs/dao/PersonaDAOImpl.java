...
public class PersonaDAOImpl implements PersonaDAO {
	...
	@Override
	public void update(Persona personaInput) throws Exception {
		personaInput = entityManager.merge(personaInput);
	}

	@Override
	public void insert(Persona personaInput) throws Exception {
		entityManager.persist(personaInput);

	}

	@Override
	public void delete(Persona personaInput) throws Exception {
		entityManager.remove(entityManager.merge(personaInput));
	}
